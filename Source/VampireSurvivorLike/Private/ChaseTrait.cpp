...
void UChaseTrait::BuildTemplate(FMassEntityTemplateBuildContext& BuildContext, const UWorld& World) const
{
	...
	FLocationRegistrationFragment& LocationRegistrationFragment = BuildContext.AddFragment_GetRef<FLocationRegistrationFragment>();
	LocationRegistrationFragment = InLocationRegistration.GetValidated();
}
